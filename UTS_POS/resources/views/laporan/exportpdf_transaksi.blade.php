...
<head>
    ...
    <title>Laporan Transaksi {{ $timestamp }}</title>
    <style>
        body {
        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th width="22%" class="text-center">Tanggal</th>
                    <th width="22%">Kode Transaksi</th>
                    <th width="10%">Kasir</th>
                    <th class="text-center" width="13%">Pembeli</th>
                    <th width="8%">Total Barang</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {{-- <td><span class="badge">{{ $t->created_at }}</span></td> --}}
                    <td class="text-center"><strong>{{ $t->created_at }}</strong></td>
                    <td><span class="badge">{{ $t->kode_transaksi }}</span></td>
                    <td>{{ $t->user->nama }}</td>
                    <td>{{ $t->pembeli }}</td>
                    <td class="text-center">{{ $t->total_barang }}</td>
