...
<body>
    ...
    <div class="report-title blue-accent">
        LAPORAN DATA SUPPLY/PASOKAN BARANG
    </div>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    {{-- <td><span class="badge">{{ $s->created_at }}</span></td> --}}
                    <td class="text-center"><strong>{{ $s->created_at }}</strong></td>
                    <td class="text-center"><span class="badge">{{ $s->barang->kode_barang }}</span></td>
